...
echo "[One-stage] SENvT-B -> Low-Rank Gated Reservoir variants"
...
for cfg in "${LRGR_CONFIGS[@]}"; do
  ...
  echo "========================================"
  echo "[One-stage] teacher=senvt-B student=$student name=$name patch=$patch reservoir=$reservoir rank=$rank"
